...
class HomeViewModel: BaseViewModel{
    ...
    func seeAll(of category: MovieSection){
    ...
    private func getDatasource(of category: MovieSection, initalPage page: Int, initialData: [BaseMovieModel])-> MoviesDatasource{
    ...
    private func getCurrentMovies(of category: MovieSection)-> [BaseMovieModel]{
        switch category {
        case .popular:
